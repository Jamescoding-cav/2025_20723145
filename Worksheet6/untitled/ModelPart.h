...
public:
    /** Constructor
     * @param data is a List (array) of strings for each property of this item (part name and visibility)
...
private:
    QList<ModelPart*>       m_childItems;       /**< List of child items */
    QList<QVariant>         m_itemData;          /**< Column data for item */
    ModelPart* m_parentItem;        /**< Pointer to parent */

    bool                    isVisible;           /**< Visibility flag */
    unsigned char           colourR;             /**< Red colour component 0-255 */
    unsigned char           colourG;             /**< Green colour component 0-255 */
    unsigned char           colourB;             /**< Blue colour component 0-255 */

    /* VTK properties - commented out until VTK installed */
